...
const   Subscribe =()  =>{
  return (
      ...
      text-bold font-palanquin'>Sign Up for more <span className='text-coral-red'>
     Update</span>& Newsletter</h3>
     <div className='lg:max-w-[40%] w-full flex items-center
     max-sm:flex-col gap-5 p-2.5 sm:border border-slate-gray rounded-full'>
           <input
